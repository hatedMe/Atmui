...
class IScroll {
    ...
    onTouchStart(e) {
        ...
        this.wrapper.style.webkitTransitionDuration = 0; // 清除动画
    ...
    onTouchEnd(e) {
        ...
        this.touches.posY = this.touches.currentPosY;
        this.touches.duration = e.timeStamp - this.touches.startTimeStamp; // 计算拖动时间

        console.log(this.wrapper.posY, '==========----------');
        ...
        //     min: 0, //this.activeSlot.minPosY,
        //     max: 60000 //this.activeSlot.maxPosY
        // });
