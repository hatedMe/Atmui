...
export default class Swipeout {
    ...
    onTouchMove(ev){
        const touch = ev.touches ? ev.touches[0] : ev
        // this.touches.diffX = touch.pageX - this.touches.startX;
        // this.touches.diffY = touch.pageY - this.touches.startY;
        ...
        // if( this.touches.diffX > -70*3){
        //     this.swipeoutContent.style.WebkitTransform = `translate3d(${this.touches.diffX}px, 0px, 0px)`;
        // }
